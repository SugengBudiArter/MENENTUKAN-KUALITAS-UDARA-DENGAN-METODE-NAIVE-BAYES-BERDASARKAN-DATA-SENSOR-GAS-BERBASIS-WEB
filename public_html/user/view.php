  ...
  <body class="sub_page">
      ...
      <section class="category_section layout_padding">
          <div class="container">
              <div class="row">
                  <div class="col-md-12">
                      <h2 class="section_heading">Data Sensor Gas </h2>
                      <br>
                      <div class="mb-3">
                        <a href="?sort=desc" class="btn btn-secondary">Data Terbaru</a>
                        <a href="?sort=asc" class="btn btn-secondary">Data Terlama</a>
                    </div>
      ...
      <footer class="container-fluid footer_section">
          <div class="container">
              <p>&copy; <span id="displayDate"></span> Create By <a href="https://github.com/SugengBudiArter">SugengBudi</a></p>
          </div>
      </footer>
